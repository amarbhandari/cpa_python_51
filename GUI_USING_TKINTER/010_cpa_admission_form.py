...
def onRegister() ->None:
    ...
    course_name = course_select_var.get()
    if course_name == '':
        print("No course is selected. Please select the course and than register")
        return None
    print("Course Name:", course_name)
    print("Name:", name_var.gett())
...
def build_front_end():
    ...
    E3.grid(row=3, column=3, sticky=(W,E))
